      ...
      <div className="max-w-7xl mx-auto space-y-8 relative z-10">
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div>
              <h2 className="text-xl font-black text-slate-900 dark:text-slate-100 tracking-tight">Daftar Produk Rekomendasi</h2>
            ...
            {!isViewer && (
              <div className="flex flex-col sm:flex-row gap-3">
                <select
                  ...
                  className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-300 px-4 py-2.5 rounded-xl text-sm font-bold focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all"
                >
          ...
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-20 opacity-50">
              <div className="w-10 h-10 border-4 border-slate-200 dark:border-slate-700 border-t-blue-600 rounded-full animate-spin mb-4"></div>
              <p className="text-slate-500 dark:text-slate-400 font-medium animate-pulse">Menarik data katalog produk...</p>
            </div>
          ) : products.length === 0 ? (
            <div className="text-center py-24 bg-slate-50 dark:bg-slate-800/30 rounded-2xl border border-dashed border-slate-200 dark:border-slate-700">
              ...
              <p className="text-slate-700 dark:text-slate-300 font-bold text-lg mb-1">Katalog Masih Kosong</p>
              <p className="text-slate-500 dark:text-slate-400 text-sm font-medium mb-6">Belum ada produk afiliasi yang kamu daftarkan ke sistem.</p>
              {!isViewer && (
                      ...
                      <td className="p-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mt-0.5 max-w-[200px] truncate" title={product.fokusProduk}>
                              {product.fokusProduk}
                            </p>
                          </div>
                        </div>
                        ...
                        {!isViewer ? (
                          <div className="flex items-center justify-end gap-2 opacity-80 group-hover:opacity-100 transition-opacity">
                            <Link 
                              ...
                              className="bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 px-3 py-1.5 rounded-lg text-xs font-bold hover:bg-slate-50 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-600 shadow-sm transition-colors"
                            >
                              ✍️ Edit
                            </Link>
                            <button 
