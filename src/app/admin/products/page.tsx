...
export default function AdminReviewsDashboard() {
  ...
  const [isAuthorized, setIsAuthorized] = useState(false); // <-- GEMBOK LAYAR (Solusi UI Flash)

  // STATE MODAL (Memastikan TypeScript membacanya dengan benar)
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Tolak jika bukan Superadmin, bukan Viewer, dan tidak punya izin Manage Ulasan
      ...
      // JIKA LOLOS PENGECEKAN: Atur state UI, buka gembok layar, dan tarik data
  ...
  const handleDelete = async (id: string, userName: string) => {
    if (isViewer) return; // Mencegah Viewer menghapus secara paksa
