...
export default async function SingleAnalyzerPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F4F4F5] p-3 sm:p-4 md:p-8 font-sans">
      <div className="max-w-5xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col space-y-3 sm:space-y-4 mb-4 sm:mb-8">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 tracking-tight">Single Ingredient 🔬</h1>
